            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
                    <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
                        <h1 className="title-font font-medium text-3xl text-gray-900">Login to reach your goals ✨</h1>
                    ...
                    <div className="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 opacity-90">
                        ...
                        <label className="inline-flex items-center mt-0">
                            <input type="checkbox" className="h-4 w-4 text-gray-600 mb-3" checked/>
                            <p className="text-sm ml-2 text-gray-500 mb-3 w-full">Remember me</p>
                        </label>  
                        <button className="text-white bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-gray-700 rounded text-lg">Login</button>
                        <p className="text-sm text-gray-500 mt-2 text-center">or</p>
                        <button className="text-gray-500 border-0 py-2 px-8 focus:outline-none hover:bg-gray-700 mt-1 rounded text-lg"> Sign up</button>
                    </div>
                </div>
        </section>
        );
